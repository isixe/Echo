    ...
    <a-layout-header>
        <div class="header-box">
            ...
            <div class="header-right">
                <a-input class="search-box" placeholder="请输入关键词" style="width: 200px" @pressEnter="onSearch">
                    <template #suffix>
                    ...
                    <template #overlay>
                        <a-menu>
                            ...
                            <a-menu-item key="2" style="display: grid;">
                                <font-awesome-icon :icon="['fas', 'question']" style="width: 20px;margin-left: -5px;" />
                                提问题
                            </a-menu-item>
                            <a-menu-item key="3" style="display: grid;">
                                <font-awesome-icon :icon="['fas', 'hashtag']" style="width: 20px;margin-left: -5px;" />
                                发动态
                            </a-menu-item>
                        </a-menu>
                    </template>
