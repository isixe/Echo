    ...
    <div class="container">
        <div class="container-left">
            <div class="register">
                ...
                <a-form class="enter-y-t-30" ref="form" :model="data" :rules="rules" :layout="formState.layout">
                    ...
                    <a-form-item name="password" label="密码">
                        <a-input-password v-model:value="data.password" size="large" placeholder="请输入密码"
                            autocomplete="new-password" />
                    </a-form-item>
                    <a-form-item name="checkPassword" label="重复密码">
                        <a-input-password v-model:value="data.checkPassword" size="large" placeholder="请输入密码"
                            @keyup.enter="handleRegister" />
                    </a-form-item>
                    <a-form-item class=".enter-y-t-5">
                        <a-button :loading="loading" class="register-submit" size="large" type="primary"
                            @click="handleRegister">注册</a-button>
                    </a-form-item>
        ...
        <div class="container-right">
            ...
            <p class="enter-y-t">发现新事物和作出新发现，是很大的满足。我们活着只为的是去发现美。其他一切都是等待的种种形式。</p>
        </div>
    </div>
</template>
