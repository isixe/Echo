<template>
    <div class="container">
        <div class="container-left">
            ...
            <p class="enter-y-t">好奇是知识的萌芽，问题不在于学到的是什么样的知识，而在于所学的知识有何用处</p>
        </div>
            ...
            <div class="login">
                ...
                <a-form class="enter-y-t-30" ref="form" :model="data" :rules="rules" :layout="formState.layout">
                    ...
                    <a-form-item name="password" label="密码">
                        <a-input-password v-model:value="data.password" size="large" placeholder="密码" autocomplete="on"
                    ...
                    <a-form-item class=".enter-y-t-5">
                        <a-button :loading="loading" class="login-submit" size="large" type="primary"
