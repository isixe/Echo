<template>
  ...
  <template>
    <a-modal v-model:open="showAddModal" width="800px" title="新增问答">
  ...
  <template>
    <a-modal ref="editModal" v-model:open="showEditModal" width="800px" title="更新问答">
      <div class="form-container">
...
const queryData = async (params) => {
  return await getQuestionListByKeyword(params).then((res) => {
    const data = res.data
