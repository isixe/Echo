            ...
            <div class="form-container">
                <a-form ref="form" v-bind="formItemLayout" :model="newData" :rules="rules">
                    ...
                    <a-form-item name="description" label="简介">
                        <a-textarea v-model:value="newData.description" placeholder="请输入简介" show-count :maxlength="60" />
                    </a-form-item>
                </a-form>
            </div>
            <template #footer>
...
const rules = {
    ...
    email: [{ pattern: '^[A-Za-z0-9\u4e00-\u9fa5]+@[a-zA-Z0-9_-]+(\\.[a-zA-Z0-9_-]+)+$', required: true, trigger: 'blur', message: '邮箱格式不正确' }]
}
