...
.header-main .user-info .user-avatar {
	margin-right: 8px;
}

.header-main .user-info .user-name {
...
.header-main .header-right .header-right-info {
	margin-right: 20px;
	height: 48px;
	line-height: 48px;
}

.header-main .header-right .header-right-info .jc-header-badge {
	height: 48px;
	line-height: 48px;
}

.header-main .header-right .header-right-info .jc-header-badge :deep(.ant-badge-dot) {
	top: 14px;
}

.header-main .header-right .header-right-info .info-icon {
	font-size: 16px;
	vertical-align: middle;
	padding: 0 4px;
	cursor: pointer;
...
.header-main .breadcrumb-container {
	line-height: 48px;
	margin-left: 20px;
}
</style>
